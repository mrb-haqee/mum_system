...
INSERT INTO `barang` VALUES (1,'MUM/inventory_barang/1/000000001','Besi','Jenis 1','Batang',1000000,'Aktif',1,'2024-09-20 06:30:27',NULL,'2024-09-20 06:30:29'),(2,'MUM/inventory_barang/1/000000003','Semen','Jenis 2','Sak',100000,'Aktif',1,'2024-09-21 01:48:47',NULL,'2024-09-21 01:48:50'),(3,'MUM/inventory_barang/1/000000004','Kabel','Jenis 2','Meter',40000,'Aktif',1,'2024-09-24 04:09:33',NULL,'2024-09-24 04:09:35'),(4,'MUM/inventory_barang/1/000000005','sekop','Jenis 1','Unit',400000,'Aktif',1,'2024-09-24 04:39:28',NULL,'2024-09-24 04:39:29'),(5,'MUM/inventory_barang/1/000000007','Kabel','Jenis 4','Roll',24244,'Aktif',1,'2024-09-26 04:16:30',NULL,'2024-09-26 04:25:48'),(6,'MUM/inventory_barang/1/000000008','Besi','dawfaw','Meter',42342,'Aktif',1,'2024-09-26 04:29:41',NULL,'2024-09-26 04:46:30');
...
INSERT INTO `biaya` VALUES (3,'MUM/biaya/1/000000003','2024-10-02','1','24dsad3da',500000,'Aktif',1,'2024-10-02 04:55:14',NULL,'2024-10-02 04:55:14');
...
INSERT INTO `biaya_detail` VALUES (6,'MUM/Biaya/1/000000003','canang',10,50000,500000,'Aktif',1,'2024-10-02 04:55:11',NULL,'2024-10-02 04:55:11');
...
INSERT INTO `pemasukan_pengeluaran_lain` VALUES (24,'MUM/pemasukan_pengeluaran_lain/1/000000024','1','Pemasukan Lain','Petty Cash',1,1000000,'edsfdfs','2024-09-30','Aktif',1,'2024-10-02 04:50:57',NULL,'2024-10-02 05:04:35');
...
--
-- Table structure for table `stock_awal`
--

DROP TABLE IF EXISTS `stock_awal`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `stock_awal` (
  `idStockAwal` bigint(20) NOT NULL AUTO_INCREMENT,
  `idInventory` bigint(20) NOT NULL,
  `tanggal` date NOT NULL,
  `tipeInventory` varchar(30) NOT NULL,
  ...
  `idUserEdit` bigint(20) DEFAULT NULL,
  `timeStampEdit` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`idStockAwal`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `stock_awal`
--
...
--
-- Table structure for table `stock_pengiriman`
--

DROP TABLE IF EXISTS `stock_pengiriman`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `stock_pengiriman` (
  `idPengiriman` bigint(20) NOT NULL AUTO_INCREMENT,
  `kodePengiriman` varchar(100) NOT NULL,
  `kodePO` varchar(100) NOT NULL,
  `tanggal` date NOT NULL,
  `statusFinalisasi` varchar(50) NOT NULL DEFAULT 'Aktif',
  `idUser` bigint(20) NOT NULL,
  `timeStamp` timestamp NOT NULL DEFAULT current_timestamp(),
  `idUserEdit` bigint(20) DEFAULT NULL,
  `timeStampEdit` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`idPengiriman`),
  UNIQUE KEY `kodePengiriman` (`kodePengiriman`),
  UNIQUE KEY `kodePO` (`kodePO`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `stock_pengiriman`
--

/*!40000 ALTER TABLE `stock_pengiriman` DISABLE KEYS */;
INSERT INTO `stock_pengiriman` VALUES (1,'MUM/stock_pengiriman/1/000000003','MUM/stock_po/1/000000013','0000-00-00','Aktif',1,'2024-10-01 23:05:23',NULL,'2024-10-01 23:05:23');
/*!40000 ALTER TABLE `stock_pengiriman` ENABLE KEYS */;

--
-- Table structure for table `stock_pengiriman_detail`
--

DROP TABLE IF EXISTS `stock_pengiriman_detail`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `stock_pengiriman_detail` (
  `idPengirimanDetail` bigint(20) NOT NULL AUTO_INCREMENT,
  `kodePengiriman` varchar(100) NOT NULL,
  ...
  `idUserEdit` bigint(20) DEFAULT NULL,
  `timeStampEdit` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `tipeInventory` varchar(30) NOT NULL DEFAULT 'barang',
  `idInventory` bigint(20) NOT NULL,
  `persentaseDiskon` decimal(15,2) NOT NULL,
  `persentasePpn` decimal(15,2) NOT NULL,
  `idPODetail` bigint(20) unsigned NOT NULL,
  PRIMARY KEY (`idPengirimanDetail`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `stock_pengiriman_detail`
--

/*!40000 ALTER TABLE `stock_pengiriman_detail` DISABLE KEYS */;
INSERT INTO `stock_pengiriman_detail` VALUES (1,'MUM/stock_pengiriman/1/000000003',12.00,'Batang',12000000.00,1000000.00,'',1,'2024-10-01 23:05:23',NULL,'2024-10-01 23:05:23','barang',1,30.00,11.00,7),(2,'MUM/stock_pengiriman/1/000000003',10.00,'Sak',1000000.00,100000.00,'',1,'2024-10-01 23:05:23',NULL,'2024-10-01 23:05:23','barang',2,30.00,11.00,8);
/*!40000 ALTER TABLE `stock_pengiriman_detail` ENABLE KEYS */;

--
-- Table structure for table `stock_po`
--

DROP TABLE IF EXISTS `stock_po`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `stock_po` (
  `idPO` bigint(20) NOT NULL AUTO_INCREMENT,
  `kodePO` varchar(100) NOT NULL,
  `kodeVendor` varchar(100) NOT NULL,
  `keterangan` text DEFAULT NULL,
  `tanggal` date NOT NULL,
  `statusFinalisasi` varchar(50) NOT NULL DEFAULT 'Generate',
  `statusPembayaran` varchar(50) NOT NULL DEFAULT 'Belum Bayar',
  `statusPO` varchar(50) NOT NULL DEFAULT 'Genereate',
  `idUser` bigint(20) NOT NULL,
  `timeStamp` timestamp NOT NULL DEFAULT current_timestamp(),
  `idUserEdit` bigint(20) DEFAULT NULL,
  `timeStampEdit` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `statusPersetujuan` varchar(255) NOT NULL DEFAULT 'Pending',
  `nomorSP` varchar(255) NOT NULL,
  `tanggalUpdate` date NOT NULL,
  `metodeBayar` varchar(255) NOT NULL,
  PRIMARY KEY (`idPO`),
  UNIQUE KEY `kodePO` (`kodePO`),
  UNIQUE KEY `nomorSP` (`nomorSP`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `stock_po`
--

/*!40000 ALTER TABLE `stock_po` DISABLE KEYS */;
INSERT INTO `stock_po` VALUES (1,'MUM/stock_po/1/000000013','MUM/vendor/1/000000002','','2024-10-01','Aktif','Belum Bayar','Diterima',1,'2024-10-01 08:11:25',1,'2024-10-02 03:37:52','Approve','12345','2024-10-01','Tunai');
/*!40000 ALTER TABLE `stock_po` ENABLE KEYS */;

--
-- Table structure for table `stock_po_detail`
--

DROP TABLE IF EXISTS `stock_po_detail`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `stock_po_detail` (
  `idPODetail` bigint(20) NOT NULL AUTO_INCREMENT,
  `kodePO` varchar(100) NOT NULL,
  `tipeInventory` varchar(30) NOT NULL,
  `idInventory` bigint(20) NOT NULL,
  `satuan` varchar(100) NOT NULL,
  ...
  `hargaSatuan` decimal(15,2) NOT NULL,
  `subTotal` decimal(15,2) NOT NULL,
  `statusItem` varchar(100) NOT NULL DEFAULT 'Aktif',
  `idUser` bigint(20) NOT NULL,
  `timeStamp` timestamp NOT NULL DEFAULT current_timestamp(),
  `idUserEdit` bigint(20) DEFAULT NULL,
  `timeStampEdit` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
...
--
-- Dumping data for table `stock_po_detail`
--

/*!40000 ALTER TABLE `stock_po_detail` DISABLE KEYS */;
INSERT INTO `stock_po_detail` VALUES (7,'MUM/stock_po/1/000000013','barang',1,'Batang',12.00,1000000.00,12000000.00,'Aktif',1,'2024-10-01 08:32:55',NULL,'2024-10-01 08:32:55'),(8,'MUM/stock_po/1/000000013','barang',2,'Sak',10.00,100000.00,1000000.00,'Aktif',1,'2024-10-01 23:05:13',NULL,'2024-10-01 23:05:13');
/*!40000 ALTER TABLE `stock_po_detail` ENABLE KEYS */;

--
-- Table structure for table `stock_po_pembayaran`
--

DROP TABLE IF EXISTS `stock_po_pembayaran`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `stock_po_pembayaran` (
  `idPOPembayaran` bigint(20) NOT NULL AUTO_INCREMENT,
  ...
  `statusPengajuan` varchar(100) NOT NULL DEFAULT 'Pending',
  `statusPelunasan` varchar(100) NOT NULL DEFAULT 'Belum Lunas',
  `tanggalPelunasan` date DEFAULT NULL,
  `statusLaporan` varchar(50) NOT NULL DEFAULT 'Belum Verifikasi',
  `idUser` bigint(20) NOT NULL DEFAULT 1,
  `timeStamp` timestamp NOT NULL DEFAULT current_timestamp(),
  `idUserEdit` bigint(20) DEFAULT NULL,
  `timeStampEdit` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `persentaseDiskon` decimal(15,2) NOT NULL DEFAULT 0.00,
  `persentasePpn` decimal(15,2) NOT NULL DEFAULT 11.00,
  PRIMARY KEY (`idPOPembayaran`),
  UNIQUE KEY `kodePO` (`kodePO`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `stock_po_pembayaran`
--

/*!40000 ALTER TABLE `stock_po_pembayaran` DISABLE KEYS */;
INSERT INTO `stock_po_pembayaran` VALUES (1,'','MUM/stock_po/1/000000013',9324000.00,3600000.00,924000.00,'0000-00-00','Pending','Belum Lunas',NULL,'Belum Verifikasi',1,'2024-10-01 08:11:25',1,'2024-10-01 08:33:11',30.00,11.00);
/*!40000 ALTER TABLE `stock_po_pembayaran` ENABLE KEYS */;

--
-- Table structure for table `stock_pr`
--

DROP TABLE IF EXISTS `stock_pr`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `stock_pr` (
  `idPR` bigint(20) NOT NULL AUTO_INCREMENT,
  `kodePR` varchar(100) NOT NULL,
  `keterangan` text DEFAULT NULL,
  `tanggal` date NOT NULL,
  `statusFinalisasi` varchar(50) NOT NULL,
  `statusPR` varchar(50) NOT NULL,
  `idUser` bigint(20) NOT NULL,
  `timeStamp` timestamp NOT NULL DEFAULT current_timestamp(),
  `idUserEdit` bigint(20) DEFAULT NULL,
  `timeStampEdit` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`idPR`),
  UNIQUE KEY `kodePR` (`kodePR`)
...
--
-- Table structure for table `stock_pr_detail`
--

DROP TABLE IF EXISTS `stock_pr_detail`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `stock_pr_detail` (
  `idPRDetail` bigint(20) NOT NULL AUTO_INCREMENT,
  `kodePR` varchar(100) NOT NULL,
  `tipeInventory` varchar(30) NOT NULL,
  `idInventory` bigint(20) NOT NULL,
  ...
  `qty` decimal(15,2) NOT NULL,
  `satuan` varchar(100) NOT NULL,
  `qtyStock` decimal(15,2) DEFAULT NULL,
  `satuanStock` varchar(30) DEFAULT NULL,
  ...
  `idUserEdit` bigint(20) DEFAULT NULL,
  `timeStampEdit` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `idPODetail` bigint(20) unsigned zerofill NOT NULL,
  PRIMARY KEY (`idPRDetail`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `stock_pr_detail`
--

/*!40000 ALTER TABLE `stock_pr_detail` DISABLE KEYS */;
/*!40000 ALTER TABLE `stock_pr_detail` ENABLE KEYS */;

--
-- Table structure for table `stock_sr`
--

DROP TABLE IF EXISTS `stock_sr`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `stock_sr` (
  `idSR` bigint(20) NOT NULL AUTO_INCREMENT,
  `kodeSR` varchar(100) NOT NULL,
  `kodePO` varchar(100) NOT NULL,
  `nomorBM` varchar(100) NOT NULL,
  `nomorFaktur` varchar(100) NOT NULL,
  `tanggal` date NOT NULL,
  `statusFinalisasi` varchar(50) NOT NULL DEFAULT 'Generate',
  `idUser` bigint(20) NOT NULL,
  `timeStamp` timestamp NOT NULL DEFAULT current_timestamp(),
  ...
  `timeStampEdit` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`idSR`),
  UNIQUE KEY `kodeSR` (`kodeSR`),
  UNIQUE KEY `kodePO` (`kodePO`),
  UNIQUE KEY `nomorBM` (`nomorBM`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `stock_sr`
--

/*!40000 ALTER TABLE `stock_sr` DISABLE KEYS */;
INSERT INTO `stock_sr` VALUES (1,'MUM/stock_sr/1/000000014','MUM/stock_po/1/000000013','12315','12341','2024-09-30','Aktif',1,'2024-10-02 03:37:52',NULL,'2024-10-02 03:37:52');
/*!40000 ALTER TABLE `stock_sr` ENABLE KEYS */;

--
-- Table structure for table `stock_sr_detail`
--

DROP TABLE IF EXISTS `stock_sr_detail`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `stock_sr_detail` (
  `idSRDetail` bigint(20) NOT NULL AUTO_INCREMENT,
  `kodeSR` varchar(100) NOT NULL,
  `qty` decimal(15,2) NOT NULL,
  `satuan` varchar(100) NOT NULL,
  `subTotal` decimal(15,2) NOT NULL,
  ...
  `idInventory` bigint(20) NOT NULL,
  `idPODetail` bigint(20) unsigned NOT NULL,
  PRIMARY KEY (`idSRDetail`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `stock_sr_detail`
--

/*!40000 ALTER TABLE `stock_sr_detail` DISABLE KEYS */;
INSERT INTO `stock_sr_detail` VALUES (1,'MUM/stock_sr/1/000000014',12.00,'Batang',9324000.00,777000.00,'Diterima',1,'2024-10-02 03:37:52',1,'2024-10-02 04:01:24','barang',1,7),(2,'MUM/stock_sr/1/000000014',10.00,'Sak',777000.00,77700.00,'Diterima',1,'2024-10-02 03:37:52',NULL,'2024-10-02 03:37:52','barang',2,8);
/*!40000 ALTER TABLE `stock_sr_detail` ENABLE KEYS */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1088 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
