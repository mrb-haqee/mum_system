...
CREATE TABLE `purchasing` (
  ...
  `kodeVendor` varchar(100) NOT NULL,
  `tanggalPurchasing` date NOT NULL,
  ...
  `ppn` decimal(15,2) NOT NULL DEFAULT 11.00,
  `keterangan` varchar(255) DEFAULT NULL,
  `tanggalUpdate` date DEFAULT NULL,
  `metodePembayaran` varchar(255) NOT NULL DEFAULT 'Tunai',
...
INSERT INTO `purchasing` VALUES (12,'MUM/purchasing/1/000000001','MUM/vendor/1/000000002','2024-09-21','Approve','Aktif',1,'2024-09-21 03:12:22',1,'2024-09-23 09:54:20',30.00,11.00,'','2024-09-23','Tunai'),(15,'MUM/purchasing/1/000000003','MUM/vendor/1/000000002','2024-09-21','Reject','Aktif',1,'2024-09-21 05:13:35',1,'2024-09-24 07:54:54',50.00,11.00,'kjnlojiljnmion','2024-09-24','Tunai'),(16,'MUM/purchasing/1/000000004','MUM/vendor/1/000000002','2024-09-21','Reject','Aktif',1,'2024-09-21 05:14:36',1,'2024-09-24 07:49:17',23.00,11.00,'','2024-09-23','Tunai'),(17,'MUM/purchasing/1/000000005','MUM/vendor/1/000000002','2024-09-24','Pending','Aktif',1,'2024-09-24 07:52:49',NULL,'2024-09-24 07:52:49',0.00,11.00,NULL,'2024-09-24','Tunai');
...
INSERT INTO `purchasing_detail` VALUES (2,'MUM/purchasing/1/000000001',1,12,'Aktif',1,'2024-09-21 03:45:54',1,'2024-09-21 03:56:29',12000000.00),(3,'MUM/purchasing/1/000000001',2,45,'Aktif',1,'2024-09-21 03:56:39',NULL,'2024-09-21 03:56:39',4500000.00),(11,'MUM/purchasing/1/000000003',2,345,'Aktif',1,'2024-09-23 09:53:46',NULL,'2024-09-23 09:53:46',34500000.00),(12,'MUM/purchasing/1/000000004',1,353,'Aktif',1,'2024-09-23 09:54:05',NULL,'2024-09-23 09:54:05',353000000.00),(13,'MUM/purchasing/1/000000005',2,45,'Aktif',1,'2024-09-24 07:52:55',NULL,'2024-09-24 07:52:55',4500000.00);
/*!40000 ALTER TABLE `purchasing_detail` ENABLE KEYS */;

--
-- Table structure for table `stock_awal_barang`
--

DROP TABLE IF EXISTS `stock_awal_barang`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `stock_awal_barang` (
  `idStockAwal` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `kodeBarang` varchar(100) NOT NULL,
  `tanggal` date NOT NULL,
...
--
-- Dumping data for table `stock_awal_barang`
--

/*!40000 ALTER TABLE `stock_awal_barang` DISABLE KEYS */;
INSERT INTO `stock_awal_barang` VALUES (1,'MUM/inventory_barang/1/000000001','2024-09-24',3435.00,1,'2024-09-24 05:01:54',NULL,'2024-09-24 05:01:54'),(3,'MUM/inventory_barang/1/000000004','2024-09-24',43643.00,1,'2024-09-24 05:02:50',NULL,'2024-09-24 05:02:50');
/*!40000 ALTER TABLE `stock_awal_barang` ENABLE KEYS */;
...
-- Dump completed on 2024-09-24 16:18:08
