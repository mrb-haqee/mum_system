...
/**
 * Parameter requirements = ["kodeRM", "kodeAntrian", "jenisSurat" => 'Surat Sehat']
 */
function viewValidatorSuratSehat(array $requirements, array $params)
{
    foreach ($requirements as $requirement) {
        if (!in_array($requirement, array_keys($params))) return false;
    }

    if ($params['jenisSurat'] !== 'Surat Sehat') return false;
    ...
    $qr_filename = escapeFilename("QRVALIDATOR_{$params['kodeAntrian']}_Surat_Sehat");
?>
    <div style="width: 100%;" class="text-center mb-10 mb-lg-20">
        ...
        <h1 class="font-weight-bolder">CONFIDENTIAL CERTIFICATE OF HEALTH</h1>
    </div>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-7 text-lg-left text-md-left text-sm-center text-center mb-4" style="font-size: 1.2rem;">
                <p>Confidential Certificate Of Health for Patient :</p>
