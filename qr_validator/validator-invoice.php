...
/**
 * Parameter requirements = ["kodeRM", "kodeAntrian", "jenisSurat" => 'Invoice']
 */
function viewValidatorInvoice(array $requirements, array $params)
{
    foreach ($requirements as $requirement) {
        if (!in_array($requirement, array_keys($params))) return false;
    }

    if ($params['jenisSurat'] !== 'Invoice') return false;
    ...
    $qr_filename = escapeFilename("QRVALIDATOR_{$params['kodeAntrian']}_Invoice");
?>
    <div style="width: 100%;" class="text-center mb-10 mb-lg-20">
        ...
        <h1 class="font-weight-bolder">PATIENT INVOICE</h1>
    </div>
    <div class="container-fluid d-flex align-items-center justify-content-center">
        <div class="row">
            ...
            <div class="col-md-7 text-lg-left text-md-left text-sm-center text-center mb-4" style="font-size: 1.2rem;">
                ...
                <p>on <strong><u><?= ubahTanggalIndo($dataAntrian['tanggalPendaftaran']); ?></u></strong> and patient examined by <strong><u><?= $dataAntrian['namaDokter']; ?></u></strong></p>
            </div>
        </div>
    </div>
<?php
