...
?>
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
                            ...
                            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                                ...
                                <div class="d-flex align-items-center flex-wrap mr-1">
                                    <div class="btn-group" role="group">
                                        <button type="button" onclick="boxPurchasing()" class="btn btn-detail-purchasing-tab btn-danger"><i class="fas fa-list-alt pr-4"></i><strong>DAFTAR PURCHASING</strong></button>
                                        <button type="button" onclick="getFormPurchasing('')" class="btn btn-detail-purchasing-tab btn-light-danger "><i class="fas fa-file-signature pr-4"></i><strong>FORM PURCHASING</strong></button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script src="js/purchasing.js?v=1.1"></script>
