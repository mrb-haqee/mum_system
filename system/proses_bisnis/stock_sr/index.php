...
if (!$dataCekUser || !$dataCekMenu || !validateIP($_SESSION['IP_ADDR'])) {
    ...
    $periode = date('Y-m-01') . ' - ' . date('Y-m-t');
?>
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
                ...
                <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
                                    ...
                                    <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                                        <div class="quick-search quick-search-dropdown">
                                            ...
                                            <div class="input-group quick-search-form">
                                                ...
                                                <input type="text" id="kataKunciData" class="form-control" placeholder="Search..." onchange="cariBudgetingProject()">
                                            </div>
                    ...
                    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        <div class="d-flex flex-column-fluid">
                            ...
                            <div class="container-fluid" id="boxPurchasing">
                                <div class="row">
                                    <div class="col-xl-2 mb-5">
                                        <div class="card card-custom">
                                            <div class="card-body">

                                                <button type="button" style="width: 100%; text-align: center;" class="btn btn-danger btn-status-type-tab mb-2" data-status="Diproses" data-daftar="pengiriman" onclick="dataDaftar('Diproses', 'pengiriman', true)">
                                                    <i class="fas fa-truck-moving d-block mb-2 pr-0 fa-2x"></i><strong class="text-uppercase">Diproses</strong>
                                                </button>
                                                <button type="button" style="width: 100%; text-align: center;" class="btn btn-light-danger btn-status-type-tab mb-2" data-status="Diterima" data-daftar="sr" onclick="dataDaftar('Diterima','sr', true)">
                                                    <i class="fas fa-truck-loading d-block mb-2 pr-0 fa-2x"></i> <strong class="text-uppercase">Diterima</strong>
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div id="kt_page_sticky_card" class="card card-custom card-sticky">
                                            <div class="card-header">
                                                ...
                                                <div class="card-title">
                                                    <h3 class="card-label"><i class="fas fa-stream pr-5 text-dark"></i> <strong>DAFTAR SERVICE RECIPT</strong></h3>
                                                </div>
                                                <!-- END CARD TITLE -->
                                            ...
                                            <div class="card-body">
                                                <div class="form-row">
                                                    <div class="form-group col-md-4">
                                                        <label for="periode"><i class="fas fa-calendar-alt"></i> RENTANG</label>
                                                        <div class="input-group">
                                                            <input type="text" id="periode" class="form-control" data-date-range="true" onchange="dataDaftar()" value="<?= $periode ?>">
                                                ...
                                                <div id="boxDataDaftar" style="overflow-x: auto;">
        ...
        <script src="js/stock_sr.js"></script>
