...
if (!$dataCekUser || !$dataCekMenu || !validateIP($_SESSION['IP_ADDR'])) {
    ...
    if (isset($param)) {
        ...
        if (isset($result['kodeSR'])) {
            $kodeSR = $result['kodeSR'];
        } else {
            $kodePengiriman = $result['kode'];
            $kodeSR = nomorUrut($db, 'stock_sr', $idUserAsli);
        }
?>
                        ...
                        <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                            ...
                            <div class="d-flex flex-column-fluid">
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <!-- IMPORTANT VARIABLE -->
                                        <input type="hidden" name="kodePengiriman" id="kodePengiriman" value="<?= $kodePengiriman ?>">
                                        <input type="hidden" name="kodeSR" id="kodeSR" value="<?= $kodeSR ?>">
                                        ...
                                        <div class="col-sm-12 col-lg-10" id="formDetail">
                                            <!-- FORM DETAIL HOTEL -->
                                        </div>
                                    </div>
