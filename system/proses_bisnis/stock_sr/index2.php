                ...
                <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
                    ...
                    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                                ...
                                <div class="d-flex align-items-center flex-wrap mr-1">
                                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                                        ...
                                        <div class="btn-group" role="group">
                                            <button type="button" onclick="dataDaftarPengiriman('Diproses')" data-in-tab='DiProses' class="btn btn-detail-purchasing-tab btn-danger"><i class="fas fa-truck-moving pr-4"></i><strong>Diproses</strong></button>
                                            <button type="button" onclick="dataDaftarPengiriman('Diterima')" data-in-tab='Diterima' class="btn btn-detail-purchasing-tab btn-light-danger "><i class="fas fa-truck-loading pr-4"></i><strong>Diterima</strong></button>
                                        </div>
                                    </div>
                        ...
                        <div class="d-flex flex-column-fluid">
                            <div class="container">
                                <div id="dataDaftarPengiriman" class="row">
