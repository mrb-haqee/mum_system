...
if (!$dataCekUser || !$dataCekMenu || !validateIP($_SESSION['IP_ADDR'])) {
    ...
    if (isset($param)) {
        ...
        $kodePO = nomorUrut($db, 'stock_po', $idUserAsli);
    }
?>
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed page-loading">
                    ...
                    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        <div class="d-flex flex-column-fluid">
                            <div class="container-fluid">
                                ...
                                <div class="row">
                                    <!-- IMPORTANT VARIABLE -->
                                    <input type="hidden" name="kodePO" id="kodePO" value="<?= $kodePO ?>">
                                        ...
                                        <div class="card card-custom">
                                            <div class="card-body">
                                                <button type="button" class="btn btn-danger btn-seksi-informasi-tab text-center mb-2" style="width:100%;" onclick="seksiFormInformasi()">
                                                    <i class="fas fa-file-signature d-block mb-2 pr-0 fa-2x"></i> <strong>INFORMASI</strong>
                                                </button>
                                                <button type="button" class="btn btn-light-danger btn-seksi-informasi-tab text-center mb-2" style="width:100%;" onclick="seksiFormPODetail()">
                                                    <i class="fas fa-tasks d-block mb-2 pr-0 fa-2x"></i> <strong>DETAIL</strong>
                                                </button>
                                    ...
                                    <div class="col-sm-12 col-lg-10" id="formDetailPO">
                                        <!-- FORM DETAIL HOTEL -->
                                    </div>
                                </div>
        ...
        <script src="js/seksi-po-detail.js"></script>
        <script src="js/seksi-po-pembayaran.js"></script>
