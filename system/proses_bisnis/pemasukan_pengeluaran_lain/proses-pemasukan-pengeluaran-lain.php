    ...
    try {
        ...
        if ($flag === 'delete') {
            $status = statementWrapper(
                DML_DELETE,
                'DELETE FROM pemasukan_pengeluaran_lain WHERE idPemasukanPengeluaranLain = ?',
            ...
            $status = statementWrapper(
                ...
                SET 
                    tanggal = ?,
                    tipe = ?, 
                    kodePemasukanPengeluaranLain = ?,
                    idSubAccount = ?,
                    jenisRekening = ?,
                    idRekening = ?,
                    nominal = ?,
                    keterangan = ?, 
                    statusPemasukanPengeluaranLain = ?,
                    idUser = ?
                    ',
                [
                    $tanggal,
            ...
            updateNomorUrut($db, 'pemasukan_pengeluaran_lain', $idUserAsli);
