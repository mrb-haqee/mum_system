    ...
    try {
        ...
        if ($flag == 'update') {
            $status = statementWrapper(
                DML_UPDATE,
                'UPDATE 
                    budgeting_project_anggaran
                SET 
                    nominal = ?,
                    idUser = ? 
                WHERE 
                    idBudgetingProjectAnggaran = ?',
                [
                    ubahToInt($nominal),
                    $idUserAsli,
                    $idBudgetingProjectAnggaran
            ...
            if ($status) {
                $pesan = 'Proses Update Anggaran Berhasil';
            } else {
                $pesan = 'Proses Update Anggaran Gagal';
            }
            ...
            if ($status) {
                $pesan = 'Proses Tambah Anggaran Berhasil';
            } else {
                $pesan = 'Proses Tambah Anggaran Gagal';
            }
