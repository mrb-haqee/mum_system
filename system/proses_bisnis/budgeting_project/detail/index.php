...
if (!$dataCekUser || !$dataCekMenu || !validateIP($_SESSION['IP_ADDR'])) {
    ...
    if (isset($param)) {
        ...
        $kodeBudgetingProject = nomorUrut($db, 'budgeting_project', $idUserAsli);
    }
?>
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed page-loading">
                                        ...
                                        <div class="card card-custom">
                                            <div class="card-body">
                                                <button type="button" class="btn btn-danger btn-seksi-informasi-tab text-center mb-2" style="width:100%;" onclick="seksiFormInformasi()">
                                                    <i class="fas fa-money-check-alt d-block mb-2 pr-0 fa-2x"></i> <strong>INFORMASI PROJECT</strong>
                                                </button>
                                                <button type="button" class="btn btn-light-danger btn-seksi-informasi-tab text-center mb-2" style="width:100%;" onclick="seksiFormTim('')">
                                                    <i class="fas fa-cash-register d-block mb-2 pr-0 fa-2x"></i> <strong>TIM</strong>
                                                </button>
                                                <button type="button" class="btn btn-light-danger btn-seksi-informasi-tab text-center mb-2" style="width:100%;" onclick="seksiFormAnggaran('')">
                                                    <i class="fas fa-cash-register d-block mb-2 pr-0 fa-2x"></i> <strong>ANGGARAN</strong>
                                                </button>
                                                <button type="button" class="btn btn-light-danger btn-seksi-informasi-tab text-center mb-2" style="width:100%;" onclick="seksiFormBiaya('')">
                                                    <i class="fas fa-cash-register d-block mb-2 pr-0 fa-2x"></i> <strong>BIAYA</strong>
                                                </button>
                                                <button type="button" class="btn btn-light-danger btn-seksi-informasi-tab text-center mb-2" style="width:100%;" onclick="seksiFormFinalisasi()">
                                                    <i class="fas fa-check-circle d-block mb-2 pr-0 fa-2x"></i> <strong>FINALISASI</strong>
                                                </button>
                                            </div>
                                        </div>
                                    </div>
        ...
        <script src="js/seksi-tim.js"></script>
        <script src="js/seksi-anggaran.js"></script>
        <script src="js/seksi-biaya.js"></script>
