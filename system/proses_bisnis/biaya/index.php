...
?>
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
                            ...
                            <div class="container">
                                ...
                                <div id="kt_page_sticky_card" class="card card-custom card-sticky">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" id="periode" class="form-control" onchange="dataDaftarBiaya()" value="<?= $rentang ?>">
                                        ...
                                        <div class="table-responsive" id="boxDaftarBiaya">
        ...
        <!-- MODAL -->
        <div id="modalFormBiaya" class="modal fade utama" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="boxFormBiaya"></div>
                </div>
            </div>
        </div>
