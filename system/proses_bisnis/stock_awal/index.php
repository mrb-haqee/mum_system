...
?>
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
								...
								<div id="kt_page_sticky_card" class="card card-custom card-sticky">
									<div class="card-header flex-wrap py-3">
										...
										<div class="card-title">
											<h3 class="card-label"><i class="fas fa-stream text-dark pr-4"></i> <strong>DAFTAR STOCK AWAL BARANG</strong></h3>
										</div>
										<!-- END CARD TITLE -->
										<!-- CARD TOOLBAR -->
										<div class="card-toolbar">
											<button id="tombolTambah" type="button" class="btn btn-danger font-weight-bolder" onclick="getFormStockAwalBarang()">
												<i class="fa fa-plus-circle"></i> <strong>STOCK BARU</strong>
											</button>
										</div>
										<!-- END CARD TOOLBAR -->
									</div>
									...
									<!-- CARD BODY -->
									<div class="card-body">
										<div class="table-responsive" id="dataDaftar">
		...
		<!-- MODAL -->
		<div id="modalFormStockAwalBarang" class="modal fade utama" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="modal-dialog modal-xl" role="document">
				<div class="modal-content">
					<div class="modal-header bg-danger">
						<h5 class="modal-title text-white">
							<i class="fas fa-box pr-5 text-white"></i> <strong>FORM STOCK AWAL BARANG</strong>
						</h5>
					</div>
					<div class="modal-body" id="boxFormStockAwalBarang"></div>
				</div>
			</div>
		</div>
		<!-- END MODAL -->
		...
		<script src="js/stock_awal_barang.js"></script>
