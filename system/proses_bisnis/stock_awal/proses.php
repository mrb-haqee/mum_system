...
if (!$dataCekUser || !$dataCekMenu || !validateIP($_SESSION['IP_ADDR']) || !$tokenValid) {
    ...
    try {
        ...
        if ($flag === 'delete') {
            ...
            if ($status) {
                $pesan = 'Proses Non Aktif Stock Awal Berhasil';
            } else {
                $pesan = 'Proses Non Aktif Stock Awal Gagal';
            }
        } else if ($flag === 'update') {
            ...
            if ($status) {
                $pesan = 'Proses Update Stock Awal Berhasil';
            } else {
                $pesan = 'Proses Update Stock Awal Gagal';
            }
        } else if ($flag === 'tambah') {
            ...
            if ($status) {
                $pesan = 'Proses Tambah Stock Awal Berhasil';
            } else {
                $pesan = 'Proses Tambah Stock Awal Gagal';
            }
        } else {
            $status = false;
