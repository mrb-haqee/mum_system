...
?>
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
        ...
        <!-- MODAL -->
        <div id="modalDetailPurchasing" class="modal fade utama" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-danger">
                        <h5 class="modal-title text-white">
                            </i><i class="fas fa-tasks pr-4"></i> <strong>DETAIL PURCHASING</strong>
                        </h5>
                    </div>
                    <div class="modal-body" id="dataDetailPurchasing"></div>
                </div>
            </div>
        </div>
        ...
        <script src="js/validasi_purchasing.js"></script>
