...
?>
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
                                ...
                                <div id="kt_page_sticky_card" class="card card-custom card-sticky">
                                    <div class="card-header">
                                        ...
                                        <div class="card-title">
                                            <h3 class="card-label"><i class="fas fa-stream text-dark pr-4 "></i> <strong>INVENTORY CONTROL</strong></h3>
                                        </div>
                                        <!-- END CARD TITLE -->
                                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" id="periode" class="form-control" data-date-range="true" onchange="dataDaftarInventory()" value="<?= $rentang ?>">
                                            ...
                                            <div class="form-group col-md-3">
                                                <label><i class="fas fa-user-tie"></i> Inventory</label>
                                                <select id="tipeInventory" name="tipeInventory" class="form-control selectpicker" data-live-search="true" onchange="dataDaftarInventory()">
                                                    <?php
                                                    $opsi =  array('barang');
                                                    foreach ($opsi as $row) {
                                                    ?>
                                        ...
                                        <!-- TABLE -->
                                        <div class="table-responsive" id="dataDaftarInventory">
        ...
        <script src="js/inventory_control.js"></script>
