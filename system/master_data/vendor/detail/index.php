...
if (!$dataCekUser || !$dataCekMenu || !validateIP($_SESSION['IP_ADDR'])) {
    ...
    if (isset($param)) {
        ...
        $kodeVendor = $result['kode'];
    } else {
        $kodeVendor = nomorUrut($db, 'vendor', $idUserAsli);
    }
?>
                    ...
                    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        <div class="d-flex flex-column-fluid">
                            <div class="container-fluid">
                                ...
                                <div class="row">
                                    <!-- IMPORTANT VARIABLE -->
                                    <input type="hidden" name="kodeVendor" id="kodeVendor" value="<?= $kodeVendor ?>">
                                        ...
                                        <div class="card card-custom">
                                            <div class="card-body">
                                                <button type="button" class="btn btn-danger btn-seksi-informasi-tab text-center mb-2" style="width:100%;" onclick="seksiFormInformasi()">
                                                    <i class="fas fa-hospital d-block mb-2 pr-0 fa-2x"></i> <strong>VENDOR</strong>
                                                </button>
                                    ...
                                    <div class="col-sm-12 col-lg-10" id="formDetailVendor">
                                        <!-- FORM DETAIL HOTEL -->
                                    </div>
                                </div>
