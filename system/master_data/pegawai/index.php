...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="<?= BASE_URL_HTML ?>/assets/plugins/custom/datatables/datatables.bundle.css" type="text/css" />
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
                ...
                <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
                    ...
                    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        <div class="d-flex flex-column-fluid">
                            <div class="container">
                                <!-- CARD -->
                                <div id="kt_page_sticky_card" class="card card-custom">
                                    <div class="card-header">
                                        <!-- CARD TITLE -->
                                        <div class="card-title">
                                            <h3 class="card-label"><i class="fas fa-stream pr-5 text-dark"></i> <strong>DAFTAR PEGAWAI</strong></h3>
                                        </div>
                                        <!-- END CARD TITLE -->
                                        <!-- CARD TOOLBAR -->
                                        <div class="card-toolbar">
                                            <a href="detail_pegawai/" class="btn btn-danger font-weight-bolder">
                                                <i class="fas fa-plus-circle pr-4"></i> <strong>PEGAWAI BARU</strong>
                                            </a>
                                        </div>
                                        <!-- END CARD TOOLBAR -->
                                    </div>
        ...
        <!-- MODAL -->
        <div id="modalFormPegawai" class="modal fade utama" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header alert alert-danger">
                        <h5 class="modal-title text-white">
                            <i class="fa fa-list-ol text-light"></i> Pegawai Baru
                        </h5>
                    </div>
                    <div class="modal-body" id="dataFormPegawai"></div>
                </div>
            </div>
        </div>
        <!-- END MODAL -->
        ...
        <script src="<?= BASE_URL_HTML ?>/assets/plugins/custom/datatables/datatables.bundle.js"></script>
