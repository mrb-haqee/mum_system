...
if (!$dataCekUser || !$dataCekMenu || !validateIP($_SESSION['IP_ADDR'])) {
    ...
    if (isset($param)) {
        ...
        $kodePegawai = $result['kode'];
    } else {
        $kodePegawai = nomorUrut($db, 'pegawai', $idUserAsli);
    }
?>
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed page-loading">
                        ...
                        <div class="d-flex flex-column-fluid">
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <input type="hidden" name="kodePegawai" id="kodePegawai" value="<?= $kodePegawai ?>">
                                        ...
                                        <div class="card card-custom">
                                            <div class="card-body">
                                                <button type="button" class="btn btn-danger btn-seksi-informasi-tab text-center mb-2" style="width:100%;" onclick="seksiFormInformasi()">
                                                    <i class="fas fa-info-circle d-block mb-2 pr-0 fa-2x"></i> <strong>INFORMASI</strong>
                                                </button>
                                                <!-- <button type="button" class="btn btn-light-danger btn-seksi-informasi-tab text-center mb-2" style="width:100%;" onclick="seksiFormPenghasilan()">
                                                    <i class="fas fa-credit-card d-block mb-2 pr-0 fa-2x"></i> <strong>PENGHASILAN</strong>
                                                </button> -->
                                    ...
                                    <div class="col-sm-12 col-lg-10" id="formDetailPegawai">
                                        <!-- FORM DETAIL HOTEL -->
                                    </div>
                                </div>
        ...
        <script src="js/seksi-penghasilan.js"></script>
