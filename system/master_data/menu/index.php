...
?>
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
									...
									<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
										<div class="quick-search quick-search-dropdown">
											...
											<div class="input-group quick-search-form">
												...
												<input type="text" id="kataKunciData" class="form-control" placeholder="Search..." onchange="dataCariDaftarMenu()">
											</div>
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<h5 class="text-dark font-weight-bold my-1 mr-5">Master Data Menu</h5>
										...
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item">
												<a href="" class="text-muted">Master Data Menu</a>
											</li>
										</ul>
									</div>
								</div>
								...
								<div id="kt_page_sticky_card" class="card card-custom card-sticky">
									<div class="card-header">
										...
										<div class="card-title">
											<h3 class="card-label"><i class="fa fa-stream pr-4 text-dark"></i> <strong>DAFTAR MENU</strong></h3>
										</div>
										<!-- END CARD TITLE -->
										<!-- CARD TOOLBAR -->
										<div class="card-toolbar">
											<button type="button" class="btn btn-primary font-weight-bolder" onclick="getFormMenu()">
												<i class="fas fa-plus-circle pr-2"></i> <strong>MENU BARU</strong>
											</button>
										</div>
										<!-- END CARD TOOLBAR -->
									</div>
									...
									<div class="card-body">
										<!-- TABLE -->
										<div class="table-responsive" id="dataDaftarMenu">
		...
		<!-- MODAL -->
		<div id="modalFormMenu" class="modal fade utama" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					<div class="modal-header bg-primary">
						<h5 class="modal-title text-white">
							<i class="fas fa-list-ol text-light pr-4"></i> <strong>FORM MENU</strong>
						</h5>
					</div>
					<div class="modal-body" id="dataFormMenu"></div>
				</div>
			</div>
		</div>

		<div id="modalFormSubMenu" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					<div id="dataFormSubMenu"></div>
				</div>
			</div>
		</div>
		<!-- END MODAL -->
		...
		<script src="js/masterdatamenu.js"></script>
		<script src="js/masterdatasubmenu.js"></script>
