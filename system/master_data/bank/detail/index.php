...
if (!$dataCekUser || !$dataCekMenu || !validateIP($_SESSION['IP_ADDR'])) {
    ...
    if (isset($param)) {
        ...
        $kodeBank = $result['kode'];
    } else {
        $kodeBank = nomorUrut($db, 'bank', $idUserAsli);
    }
?>
                    ...
                    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        <div class="d-flex flex-column-fluid">
                            <div class="container-fluid">
                                ...
                                <div class="row">
                                    <!-- IMPORTANT VARIABLE -->
                                    <input type="hidden" name="kodeBank" id="kodeBank" value="<?= $kodeBank ?>">
                                    ...
                                    <div class="col-sm-12 col-lg-10" id="formDetailBank">
                                        <!-- FORM DETAIL HOTEL -->
                                    </div>
                                </div>
