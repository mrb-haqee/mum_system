...
?>
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
                                ...
                                <div id="kt_page_sticky_card" class="card card-custom card-sticky">
                                    <div class="card-header">
                                        ...
                                        <div class="card-title">
                                            <h3 class="card-label"><i class="fas fa-stream text-dark pr-4"></i> <strong>DAFTAR DEPARTEMEN PEGAWAI</strong></h3>
                                        </div>
                                        <!-- END CARD TITLE -->
                                        <!-- CARD TOOLBAR -->
                                        <div class="card-toolbar">
                                            <button id="tombolTambahDepartemenPegawai" type="button" class="btn btn-danger font-weight-bolder">
                                                <i class="fa fa-plus-circle pr-4"></i> <strong>DEPARTEMEN PEGAWAI BARU</strong>
                                            </button>
                                        </div>
                                        <!-- END CARD TOOLBAR -->
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <!-- TABLE -->
                                        <div class="table-responsive" id="dataDaftarDepartemenPegawai">
        ...
        <!-- MODAL -->
        <div id="modalFormDepartemenPegawai" class="modal fade utama" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-danger">
                        <h5 class="modal-title text-white">
                            <i class="fas fa-list-ol text-light pr-4"></i> <strong>FORM DEPARTEMEN PEGAWAI</strong>
                        </h5>
                    </div>
                    <div class="modal-body" id="dataFormDepartemenPegawai"></div>
                </div>
            </div>
        </div>
        <!-- END MODAL -->
        ...
        <script src="js/departemen_pegawai.js"></script>
