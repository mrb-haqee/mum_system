...
?>
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
                                ...
                                <div id="kt_page_sticky_card" class="card card-custom card-sticky">
                                    <div class="card-header">
                                        ...
                                        <div class="card-title">
                                            <h3 class="card-label"><i class="fa fa-stream text-dark pr-2"></i> <strong>DAFTAR BARANG</strong></h3>
                                        </div>
                                        <!-- END CARD TITLE -->
                                        <!-- CARD TOOLBAR -->
                                        <div class="card-toolbar">
                                            <a href="detail/" class="btn btn-danger font-weight-bolder">
                                                <i class="fas fa-plus-circle pr-3"></i> <strong>BARANG BARU</strong>
                                            </a>
                                        </div>
                                        <!-- END CARD TOOLBAR -->
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <!-- TABLE -->
                                        <div class="table-responsive" id="dataDaftarBarang">
                                            <!-- DISINI TAMPIL DAFTAR Barang DAN Barang YANG SUDAH DIBUAT -->
                                        </div>
                                        <!-- END TABLE -->
                                    </div>
                                    <!-- END CARD BODY -->
        ...
        <!-- MODAL -->
        <div id="modalFormBarang" class="modal fade utama" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header alert alert-danger">
                        <h5 class="modal-title text-white">
                            <i class="fas fa-list-ol text-light pr-3"></i> <strong>Barang BARU</strong>
                        </h5>
                    </div>
                    <div class="modal-body" id="dataFormBarang"></div>
                </div>
            </div>
        </div>
        <!-- END MODAL -->
