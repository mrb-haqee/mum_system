...
if (!$dataCekUser || !$dataCekMenu || !validateIP($_SESSION['IP_ADDR'])) {
    ...
    if ($flag === 'daftar') {
        ...
        $parameter['nama'] = 'AND namaBarang LIKE ?';
        $execute[] = "%$kataKunci%";
    }

    $dataBarang = statementWrapper(
        DML_SELECT_ALL,
        "SELECT
            *
        FROM
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="dropdown-menu menu-aksi" aria-labelledby="dropdownMenuButton">
                            ...
                            <button type="button" class="btn btn-danger btn-sm tombol-dropdown-last" onclick="konfirmasiBatalBarang('<?= $row['kodeBarang'] ?>', '<?= $tokenCSRF ?>')">
                    ...
                    <td>
                        ...
                        <span class="text-muted font-weight-bold">Nama Barang</span>
                    </td>

                    <td>
                        <span class="d-block font-weight-bold"><?= $row['jenisBarang'] ?></span>
                    ...
                    <td class="text-right">
                        <span class="d-block font-weight-bold">Rp <?= ubahToRp($row['hargaBarang']) ?></span>
                        <span class="text-muted font-weight-bold">Harga Barang</span>
                    </td>
                </tr>
            <?php
                $n++;
