...
?>
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed page-loading">
                    ...
                    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        <div class="d-flex flex-column-fluid">
                            <div class="container-fluid">
                                ...
                                <div class="row">
                                    <!-- IMPORTANT VARIABLE -->
                                    <input type="hidden" name="idUserAkses" id="idUserAkses" value="<?= $idUserAkses ?>">

                                    <div class="col-sm-12 col-lg-2 mb-5">
                                        <div class="card card-custom">
                                            <div class="card-body">
                                                <button type="button" class="btn btn-light-danger btn-seksi-informasi-tab text-center mb-2" style="width:100%;" onclick="seksiFormDashboard()">
                                                    <i class="fas fa-th-list d-block mb-2 pr-0 fa-2x"></i> <strong class="text-uppercase">DASHBOARD</strong>
                                                </button>
                                                <?php
                                                $menus = statementWrapper(
                                                    DML_SELECT_ALL,
                                                    'SELECT * FROM menu WHERE statusMenu = ?',
                                                    ['Aktif']
                                                );
                                                ...
                                                foreach ($menus as $index => $menu) {
                                                    if ($index === 0) {
                                                        ...
                                                        $color = 'btn btn-light-danger';
                                                    }
                                                ?>
                                                    <button type="button" class="btn <?= $color ?> btn-seksi-informasi-tab text-center mb-2" style="width:100%;" onclick="seksiFormAkses(<?= $menu['idMenu'] ?>)">
                                                        <i class="<?= $menu['iconClass'] ?> d-block mb-2 pr-0 fa-2x"></i> <strong class="text-uppercase"><?= $menu['namaMenu']; ?></strong>
                                                    </button>
                                                <?php
                                                }
                                                ?>
                                    ...
                                    <div class="col-sm-12 col-lg-10" id="formDetailAkses">
                                        <!-- FORM DETAIL HOTEL -->
                                    </div>
                                </div>
        ...
        <script src="js/seksi-akses.js"></script>
