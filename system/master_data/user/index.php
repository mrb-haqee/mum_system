...
if (!$dataCekUser || !$dataCekMenu) {
	header("location: {$constant('BASE_URL_HTML')}/?flagNotif=gagal");
} else {
...
?>
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
									...
									<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
										<div class="quick-search quick-search-dropdown">
											...
											<div class="input-group quick-search-form">
												...
												<input type="text" id="kataKunciData" class="form-control" placeholder="Search..." onchange="dataCariDaftarUser()">
											</div>
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<h5 class="text-dark font-weight-bold my-1 mr-5">Master Data User</h5>
										...
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item">
												<a href="" class="text-muted">Master Data User</a>
											</li>
										</ul>
									</div>
								</div>
								...
								<div id="kt_page_sticky_card" class="card card-custom card-sticky">
									<div class="card-header flex-wrap py-3">
										...
										<div class="card-title">
											<h3 class="card-label"><i class="fas fa-stream pr-4 text-dark"></i> <strong>DAFTAR USER</strong></h3>
										</div>
										<!-- END CARD TITLE -->
										<!-- CARD TOOLBAR -->
										<div class="card-toolbar">
											<button type="button" class="btn btn-primary font-weight-bolder" onclick="getFormUser()">
												<i class="fas fa-plus-circle pr-4"></i><strong>USER BARU</strong>
											</button>
										</div>
										<!-- END CARD TOOLBAR -->
									</div>
									...
									<div class="card-body">
										<!-- TABLE -->
										<div class="table-responsive" id="dataDaftarUser">
											<!-- DISINI TAMPIL DAFTAR MENU YANG SUDAH DIBUAT -->
										</div>
										<!-- END TABLE -->
									</div>
									<!-- END CARD BODY -->
		...
		<!-- MODAL -->
		<div id="modalFormUser" class="modal fade utama" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					<div class="modal-header bg-primary">
						<h5 class="modal-title text-white">
							<i class="fas fa-users text-light pr-4"></i> <strong>USER BARU</strong>
						</h5>
					</div>
					<div class="modal-body" id="dataFormUser"></div>
				</div>
			</div>
		</div>
		...
		<div id="modalAksesMenu" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content" id="boxDaftarAksesMenu">
		...
		<script src="<?= BASE_URL_HTML ?>/assets/custom_js/sorting.js"></script>
		<script src="js/user.js"></script>
		<script src="js/akses_menu.js"></script>
