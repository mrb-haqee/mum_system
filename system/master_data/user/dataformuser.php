...
?>
    <form id="formUser">
        ...
        <div class="form-group">
            ...
            <select name="idPegawai" id="idPegawai" class="form-control selectpicker">
                <option value="">Pilih Pegawai</option>
                <?php
                $opsi = selectStatement('SELECT * FROM pegawai WHERE statusPegawai = ?', ['oke']);
        ...
        <div class="form-group">
            <label>USER</label>
            <input type="text" id="namaLengkap" name="namaLengkap" class="form-control" placeholder="Nama Lengkap" value="<?= $dataUpdate['namaLengkap'] ?>">
        </div>
