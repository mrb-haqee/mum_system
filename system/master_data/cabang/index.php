                                ...
                                <div id="kt_page_sticky_card" class="card card-custom card-sticky">
                                    <div class="card-header">
                                        ...
                                        <div class="card-title">
                                            <h3 class="card-label"><i class="fas fa-stream text-dark pr-4"></i> <strong>DAFTAR CABANG</strong></h3>
                                        </div>
                                        <!-- END CARD TITLE -->
                                        <!-- CARD TOOLBAR -->
                                        <div class="card-toolbar">
                                            <a href="detail_cabang/" class="btn btn-danger font-weight-bolder">
                                                <i class="fas fa-plus-circle pr-4"></i> <strong>CABANG BARU</strong>
                                            </a>
                                        </div>
                                        <!-- END CARD TOOLBAR -->
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <!-- TABLE -->
                                        <div class="table-responsive" id="dataDaftarCabang">
