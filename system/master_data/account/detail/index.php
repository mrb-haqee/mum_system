...
if (!$dataCekUser || !$dataCekMenu || !validateIP($_SESSION['IP_ADDR'])) {
    ...
    //     $codeAccount = $result['id'];
    // }

    if (isset($param)) {
        parse_str(dekripsi(rawurldecode($param), secretKey()), $result);
        $kodeAccount = $result['kodeAccount'];
    } else {
        $kodeAccount = nomorUrut($db, 'account', $idUserAsli);
    }
?>
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed page-loading">
                    ...
                    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        <div class="d-flex flex-column-fluid">
                            <div class="container-fluid">
                                ...
                                <div class="row">
                                    <!-- IMPORTANT VARIABLE -->
                                    <input type="hidden" name="kodeAccount" id="kodeAccount" value="<?= $kodeAccount ?>">

                                    <div class="col-sm-12 col-lg-2 mb-5">
                                        <div class="card card-custom">
                                            <div class="card-body">
                                                <button type="button" class="btn btn-danger btn-tab text-center mb-2" style="width:100%;" onclick="seksiFormInformasi()">
                                                    <i class="fas fa-money-check-alt d-block mb-2 pr-0 fa-2x"></i> <strong>ACCOUNT</strong>
                                                </button>
                                                <button type="button" class="btn btn-light-danger btn-tab text-center mb-2" style="width:100%;" onclick="seksiFormSubAccount()">
                                                    <i class="fas fa-money-check-alt d-block mb-2 pr-0 fa-2x"></i> <strong>SUB ACCOUNT</strong>
                                                </button>
                                                <button type="button" class="btn btn-light-danger btn-tab text-center mb-2" style="width:100%;" onclick="seksiFormFinalisasi()">
                                    ...
                                    <div class="col-sm-12 col-lg-10" id="formDetailAccount">
                                        <!-- FORM DETAIL HOTEL -->
                                    </div>
                                </div>
        ...
        <script src="js/seksi-sub-account.js"></script>
