...
if (!$dataCekUser || !$dataCekMenu || !validateIP($_SESSION['IP_ADDR'])) {
    ...
    if (isset($param)) {
        ...
        $kodePettyCash = $result['kode'];
    } else {
        $kodePettyCash = nomorUrut($db, 'tujuan_transfer', $idUserAsli);
    }
?>
                    ...
                    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        <div class="d-flex flex-column-fluid">
                            <div class="container-fluid">
                                ...
                                <div class="row">
                                    <!-- IMPORTANT VARIABLE -->
                                    <input type="hidden" name="kodePettyCash" id="kodePettyCash" value="<?= $kodePettyCash ?>">
                                        ...
                                        <div class="card card-custom">
                                            <div class="card-body">
                                                <button type="button" class="btn btn-danger btn-seksi-informasi-tab text-center mb-2" style="width:100%;" onclick="seksiFormInformasi()">
                                                    <i class="fas fa-money-check-alt d-block mb-2 pr-0 fa-2x"></i> <strong>PETTY CASH</strong>
                                                </button>
                                    ...
                                    <div class="col-sm-12 col-lg-10" id="formDetailPettyCash">
                                        <!-- FORM DETAIL HOTEL -->
                                    </div>
                                </div>
