                                ...
                                <div id="kt_page_sticky_card" class="card card-custom card-sticky">
                                    <div class="card-header">
                                        ...
                                        <div class="card-title col-8">
                                            <h3 class="card-label"><i class="fas fa-stream text-dark pr-5"></i> <strong>REPORT KAS BANK</strong></h3>
                                        </div>
                                        <!-- END CARD TITLE -->
                                        <!-- CARD TOOLBAR -->
                                        <div class="card-toolbar">
                                            <a href="excel/" class="btn btn-danger font-weight-bolder">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <select class="form-control select2" id="idRekening" name="idRekening" onchange="dataDaftarReportBank()" style="width: 100%;">
                                                    <option value="">Pilih Bank</option>
                                                    <?php
                                                    $dataBank = statementWrapper(
                                                        DML_SELECT_ALL,
                                                        "SELECT * FROM bank WHERE statusBank = ?",
                                                        ['Aktif']
                                                    );

                                                    foreach ($dataBank as $row) {
                                                    ?>
                                                        <option value="<?= $row['idBank'] ?>">
