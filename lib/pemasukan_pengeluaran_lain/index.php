...
?>
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
                                ...
                                <div id="kt_page_sticky_card" class="card card-custom card-sticky">
                                    <div class="card-header">
                                        ...
                                        <div class="card-title col-8">
                                            <h3 class="card-label"><i class="fas fa-stream text-dark pr-5"></i> <strong>DAFTAR PEMASUKAN PENGELUARAN LAIN</strong></h3>
                                        </div>
                                        <!-- END CARD TITLE -->
                                        <!-- CARD TOOLBAR -->
                                        <div class="card-toolbar">
                                            <button type="button" class="btn btn-danger" onclick="getFormPemasukanPengeluaranLain()">
                                                <i class="fas fa-plus-circle pr-4"></i><strong>PEMASUKAN/PENGELUARAN</strong>
                                            </button>
                                        </div>
                                        <!-- END CARD TOOLBAR -->
                                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" id="periode" class="form-control" onchange="dataDaftarPemasukanPengeluaranLain()" value="<?= $rentang ?>">
                                        ...
                                        <div class="table-responsive" id="boxDaftarPemasukanPengeluaranLain">
                                            <!-- DISINI TAMPIL DAFTAR DEPARTEMEN YANG SUDAH DIBUAT -->
                                        </div>
                                        <!-- END TABLE -->
                                    </div>
                                    <!-- END CARD BODY -->
        ...
        <!-- MODAL -->
        <div id="modalFormPemasukanPengeluaranLain" class="modal fade utama" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-primary">
                        <h5 class="modal-title text-white">
                            <i class="fas fa-network-wired text-light pr-4"></i> <strong>FORM PEMASUKAN PENGELUARAN LAIN</strong>
                        </h5>
                    </div>
                    <div class="modal-body" id="boxFormPemasukanPengeluaranLain"></div>
                </div>
            </div>
        </div>
        ...
        <script src="js/pemasukan-pengeluaran-lain.js"></script>
