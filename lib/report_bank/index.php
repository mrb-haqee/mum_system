...
?>
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
                                ...
                                <div id="kt_page_sticky_card" class="card card-custom card-sticky">
                                    <div class="card-header">
                                        ...
                                        <div class="card-title col-8">
                                            <h3 class="card-label"><i class="fas fa-stream text-dark pr-5"></i> <strong>REPORT BANK</strong></h3>
                                        </div>
                                        <!-- END CARD TITLE -->
                                        <!-- CARD TOOLBAR -->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" id="periode" name="periode" class="form-control" onchange="dataDaftarReportBank()" value="<?= $rentang ?>">
                                            ...
                                            <div class="form-group col-md-4">
                                                <label><i class="fas fa-user-tie"></i> BANK </label><br>
                                                <select class="form-control select2" id="idBank" name="idBank" onchange="dataDaftarReportBank()" style="width: 100%;">
                                                    ...
                                                    ?>
                                                        <option value="<?= $row['idTujuanTransfer'] ?>">
                                                            <?= $row['vendor'] ?> / <?= $row['atasNama'] ?>
                                                        </option>
                                                    <?php
                                                    }
                                                    ?>
                                            ...
                                            <div class="form-group col-md-4" id="boxCurrency">
                                                <label for="currency"><i class="fas fa-money-check-alt"></i> CURRENCY</label>
                                                <select id="currency" name="currency" class="form-control select2" onchange="dataDaftarReportBank()" style="width: 100%;">
                                                    <?php
                                        ...
                                        <div class="table-responsive" id="boxDaftarReportBank">
        ...
        <script src="js/report-bank.js"></script>
