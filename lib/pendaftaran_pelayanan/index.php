...
?>
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
                ...
                <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
                    ...
                    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                            ...
                            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                                ...
                                <div class="d-flex align-items-center flex-wrap mr-1">
                                    <div class="btn-group" role="group">
                                        <button type="button" onclick="boxPendaftaran()" class="btn btn-detail-register-tab btn-primary"><i class="fas fa-list-alt pr-4"></i><strong>DAFTAR PENDAFTARAN</strong></button>
                                        <button type="button" onclick="getFormPendaftaran()" class="btn btn-detail-register-tab btn-light-primary "><i class="fas fa-file-signature pr-4"></i><strong>FORM PENDAFTARAN</strong></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex flex-column-fluid">
                            ...
                            <div class="container-fluid" id="boxPendaftaranPelayanan">
        ...
        <script src="js/pendaftaran-pelayanan.js"></script>
