...
if (!$dataCekUser || !$dataCekMenu || !validateIP($_SESSION['IP_ADDR'])) {
    ...
    if ($dataWilayah) {
        $provinceCode = $dataWilayah['provinceCode'];
        $regencyCode = $dataWilayah['regencyCode'];

        $districtCode = $dataWilayah['districtCode'];
        $villageCode = $dataWilayah['villageCode'];
    }
