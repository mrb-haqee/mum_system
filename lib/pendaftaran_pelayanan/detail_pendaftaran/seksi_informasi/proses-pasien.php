...
if (!$dataCekUser || !$dataCekMenu || !validateIP($_SESSION['IP_ADDR']) || !$tokenValid) {
    ...
    try {
        ...
        if ($flag === 'daftar') {
            ...
            if ($status) {
                $pesan = 'Proses Daftar Pasien Berhasil';
                updateNomorUrut($db, 'rekam_medis', $idUserAsli);
                ...
                $pesan = 'Proses Daftar Pasien Gagal';
            }
        } else if ($flag === 'update') {
            ...
            if ($status) {
                $pesan = 'Proses Update Pasien Berhasil';
                $status = statementWrapper(
                    DML_INSERT,
                    'INSERT INTO 
                        pasien_satusehat
                ...
                $pesan = 'Proses Update Pasien Gagal';
            }
        } else {
            $status = false;
