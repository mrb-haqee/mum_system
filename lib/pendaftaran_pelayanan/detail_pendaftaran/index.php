...
?>
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed page-loading">
                        ...
                        <div class="d-flex flex-column-fluid">
                            <div class="container-fluid">
                                ...
                                <div class="row">
                                    ...
                                    <input type="hidden" name="paramAdmisi" value="<?= $paramAdmisi ?>">

                                    <div class="col-sm-12 col-lg-2 mb-5">
                                        <div class="card card-custom">
                                            <div class="card-body">
                                                <button type="button" class="btn btn-primary btn-seksi-informasi-tab text-center mb-2" style="width:100%;" onclick="seksiFormInformasi()">
                                                    <i class="fas fa-user-md d-block mb-2 pr-0 fa-2x"></i> <strong>INFORMASI PASIEN</strong>
                                                </button>
                                                <button type="button" class="btn btn-light-primary btn-seksi-informasi-tab text-center mb-2" style="width:100%;" onclick="seksiFormAdmisi()">
                                                    <i class="fas fa-hospital d-block mb-2 pr-0 fa-2x"></i> <strong>ADMISI</strong>
                                                </button>
                                                <button type="button" class="btn btn-light-primary btn-seksi-informasi-tab text-center mb-2" style="width:100%;" onclick="seksiFormFinalisasi()">
                                    ...
                                    <div class="col-sm-12 col-lg-10" id="formDetailPendaftaran">
                                        <!-- FORM DETAIL HOTEL -->
                                    </div>
                                </div>
        ...
        <script src="js/seksi-admisi.js"></script>
