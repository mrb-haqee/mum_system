...
if (!$dataCekUser || !$dataCekMenu || !validateIP($_SESSION['IP_ADDR'])) {
    ...
    $dataFee = statementWrapper(
        DML_SELECT,
        'SELECT * FROM pasien_fee WHERE kodeAntrian = ?',
        [$kodeAntrian]
    );
                ...
                <div class="card-title">
                    <h3 class="card-label">
                        <span class="card-label font-weight-bolder text-dark d-block">
                            <i class="fa fa-diagnoses text-dark"></i> Fee
                        </span>
                    ...
                    <form id="formFee">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <select name="referrer" id="referrer" class="form-control selectpicker" onchange="selectReferrer()" data-live-search="true" style="width: 100%;">
                                    ...
                                    <?php
                                        ...
                                        $opsi = $dataFee['referrer'] ? [$dataFee['referrer']] : ['', 'Hotel', 'Guide', 'Perorangan'];
                                    }

                                    foreach ($opsi as $row) {
                                        $selected = selected($row, $dataFee['referrer'] ?? '');
                                    ?>
                        ...
                        ?>
                            <div class="form-group">
                                <button type="button" class="btn btn-primary" onclick="prosesFee()">
