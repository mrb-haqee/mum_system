    ...
    try {
        ...
        if ($flag === 'delete') {
            ...
            $status = statementWrapper(
                DML_DELETE,
                'DELETE FROM pasien_alkes_klinik WHERE idAlkesKlinik = ?',
                [$id]
            );

            if ($status) {
                $pesan = 'Proses Delete Alkes Berhasil';
            } else {
                $pesan = 'Proses Delete Alkes Gagal';
            }
        } else if ($flag === 'tambah') {
            ...
            [$hargaBeli, $satuan] = statementWrapper(
                DML_SELECT,
                'SELECT hargaBeli, satuanPenjualan FROM alkes WHERE idAlkes = ?',
                [$idAlkes]
            );
            ...
            if ($status) {
                $pesan = 'Proses Tambah Alkes Berhasil';
            } else {
                $pesan = 'Proses Tambah Alkes Gagal';
            }
        } else {
            $status = false;
