                ...
                <div class="card-title">
                    <h3 class="card-label">
                        <span class="card-label font-weight-bolder text-dark d-block">
                            <i class="fa fa-diagnoses text-dark"></i> Tindakan Yang Diberikan
                        </span>
                        ...
                        <form id="formTindakan">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-sm-12">
                                    ...
                                    <select name="idTindakan" id="idTindakan" class="form-control selectpicker" onchange="showHarga('tindakan')" data-live-search="true" style="width: 100%;">
                                        ...
                                        foreach ($opsi as $row) {
                                        ?>
                                            <option value="<?= $row['idTindakan'] ?>"> <?= $row['nama'] ?> </option>
                                        <?php
                                        }
                                        ?>
                                    </select>
                                ...
                                <div class="form-group col-sm-4">
                                    <label>Harga</label>
                                    <input type="text" name="harga" id="hargaTindakan" placeholder="Harga" data-format-rupiah="active" class="form-control" onkeyup="showSubTotal('#hargaTindakan','#qtyTindakan','#subTotalTindakan');">
                                </div>
                                <div class="form-group col-sm-4">
                                    <label>Qty</label>
                                    <input type="text" name="qty" id="qtyTindakan" placeholder="Qty" class="form-control" data-format-rupiah="active" onkeyup="showSubTotal('#hargaTindakan','#qtyTindakan','#subTotalTindakan');">
                                </div>
                                <div class="form-group col-sm-4">
                                    <label>Subtotal</label>
                                    <input type="text" name="subTotal" id="subTotalTindakan" placeholder="Sub Total" data-format-rupiah="active" class="form-control" readonly>
                                </div>
                            </div>

                            <div class="form-group">
                                <button type="button" class="btn btn-primary" onclick="prosesTindakan()">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                                <button type="button" class="btn btn-danger btn-sm" onclick="konfirmasiBatal('<?= $row['idTindakanKlinik'] ?>','<?= $tokenCSRF ?>', 'tindakan')">
                                        ...
                                        <td>
                                            ...
                                            <span class="text-muted font-weight-bold">Nama Tindakan</span>
                                        </td>
                                        <td>
