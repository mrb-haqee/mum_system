    ...
    try {
        ...
        if ($flag === 'delete') {
            ...
            $status = statementWrapper(
                DML_DELETE,
                'DELETE FROM pasien_tindakan_klinik WHERE idTindakanKlinik = ?',
                [$id]
            );

            if ($status) {
                $pesan = 'Proses Delete Tindakan Berhasil';
            } else {
                $pesan = 'Proses Delete Tindakan Gagal';
            }
        } else if ($flag === 'tambah') {
            ...
            if ($status) {
                $pesan = 'Proses Tambah Tindakan Berhasil';
            } else {
                $pesan = 'Proses Tambah Tindakan Gagal';
            }
        } else {
            $status = false;
