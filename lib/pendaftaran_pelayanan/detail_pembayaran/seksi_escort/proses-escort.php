    ...
    try {
        ...
        if ($flag === 'delete') {
            ...
            $status = statementWrapper(
                DML_DELETE,
                'DELETE FROM pasien_escort_klinik WHERE idEscortKlinik = ?',
                [$id]
            );

            if ($status) {
                $pesan = 'Proses Delete Escort Berhasil';
            } else {
                $pesan = 'Proses Delete Escort Gagal';
            }
        } else if ($flag === 'tambah') {
            ...
            if ($status) {
                $pesan = 'Proses Tambah Escort Berhasil';
            } else {
                $pesan = 'Proses Tambah Escort Gagal';
            }
        } else {
            $status = false;
