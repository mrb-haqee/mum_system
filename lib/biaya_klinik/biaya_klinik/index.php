...
?>
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
                                ...
                                <div id="kt_page_sticky_card" class="card card-custom card-sticky">
                                    <div class="card-header">
                                        ...
                                        <div class="card-title col-8">
                                            <h3 class="card-label"><i class="fas fa-stream text-dark pr-5"></i> <strong>DAFTAR BIAYA</strong></h3>
                                        </div>
                                        <!-- END CARD TITLE -->
                                        <!-- CARD TOOLBAR -->
                                        <div class="card-toolbar">
                                            <button type="button" class="btn btn-primary" onclick="getFormBiayaKlinik()">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" id="periode" class="form-control" onchange="dataDaftarBiayaKlinik()" value="<?= $rentang ?>">
                                        ...
                                        <div class="table-responsive" id="boxDaftarBiayaKlinik">
        ...
        <!-- MODAL -->
        <div id="modalFormBiayaKlinik" class="modal fade utama" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-danger">
                        <h5 class="modal-title text-white">
                            <i class="fas fa-network-wired text-light pr-4"></i> <strong>FORM BIAYA</strong>
                        </h5>
                    </div>
                    <div class="modal-body" id="boxFormBiayaKlinik"></div>
                </div>
            </div>
        </div>
        ...
        <script src="js/biaya-klinik.js"></script>
