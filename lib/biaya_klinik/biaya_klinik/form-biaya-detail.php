...
?>
    <form id="formBiayaDetail">
        ...
        <input type="hidden" name="idBiayaKlinikDetail" value="<?= $idBiayaKlinikDetail ?>">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="hargaSatuan" id="hargaSatuan" class="form-control" data-format-rupiah="active" value="<?= ubahToRp($dataUpdateDetail['hargaSatuan'] ?? 0) ?>" onkeyup="showSubTotal()">
                </div>
            </div>
            <div class="form-group col-md-3">
            ...
            <table class="table table-hover table-bordered">
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <div class="dropdown-menu menu-aksi" aria-labelledby="dropdownMenuButton">
                                    <button type="button" class="btn btn-warning btn-sm tombol-dropdown" onclick="getFormBiayaDetail('<?= $row['idBiayaKlinikDetail'] ?>')">
                                        <i class="fas fa-edit"></i> <strong>EDIT</strong>
                                    </button>
                                    <button type="button" class="btn btn-danger btn-sm tombol-dropdown-last" onclick="deleteBiayaDetail('<?= $row['idBiayaKlinikDetail'] ?>','<?= $row['kodeBiaya'] ?>', '<?= $tokenCSRF ?>')">
                    ...
                    <tr>
                        ...
                        <input type="hidden" name="grandTotal" id="grandTotal" value="<?= $total ?>" form="formBiayaKlinik">
                    </tr>
                </tbody>
            </table>
        <?php
