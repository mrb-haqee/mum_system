...
function prosesTujuanTransfer() {
    const formTujuanTransfer = document.getElementById("formTujuanTransfer");
    const dataForm = new FormData(formTujuanTransfer);

    const validasi = formValidation(dataForm);

    if (validasi) {
        $.ajax({
            url: "seksi_informasi/proses-tujuan-transfer.php",
            type: "post",
