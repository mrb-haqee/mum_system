...
if (!$dataCekUser || !$dataCekMenu || !validateIP($_SESSION['IP_ADDR'])) {
    ...
    if (isset($param)) {
        ...
        $kodeTujuanTransfer = $result['kode'];
    } else {
        $kodeTujuanTransfer = nomorUrut($db, 'tujuan_transfer', $idUserAsli);
    }
?>
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed page-loading">
                    ...
                    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        <div class="d-flex flex-column-fluid">
                            <div class="container-fluid">
                                ...
                                <div class="row">
                                    <!-- IMPORTANT VARIABLE -->
                                    <input type="hidden" name="kodeTujuanTransfer" id="kodeTujuanTransfer" value="<?= $kodeTujuanTransfer ?>">
                                        ...
                                        <div class="card card-custom">
                                            <div class="card-body">
                                                <button type="button" class="btn btn-danger btn-seksi-informasi-tab text-center mb-2" style="width:100%;" onclick="seksiFormInformasi()">
                                                    <i class="fas fa-money-check-alt d-block mb-2 pr-0 fa-2x"></i> <strong>TUJUAN TRANSFER</strong>
                                                </button>
                                                <button type="button" class="btn btn-light-danger btn-seksi-informasi-tab text-center mb-2" style="width:100%;" onclick="seksiFormEDC()">
                                                    <i class="fas fa-cash-register d-block mb-2 pr-0 fa-2x"></i> <strong>EDC</strong>
                                                </button>
                                    ...
                                    <div class="col-sm-12 col-lg-10" id="formDetailTujuanTransfer">
                                        <!-- FORM DETAIL HOTEL -->
                                    </div>
                                </div>
        ...
        <script src="js/seksi-edc.js"></script>
