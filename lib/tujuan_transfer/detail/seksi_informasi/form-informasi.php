            ...
            <div class="card-title">
                <h3 class="card-label">
                    <span class="card-label font-weight-bolder text-dark d-block">
                        <i class="fa fa-info-circle text-dark"></i> Informasi Tujuan Transfer
                    </span>
            ...
            <form id="formTujuanTransfer">
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        <label><i class="fas fa-id-card"></i> No. Referensi</label>
                        <input type="text" class="form-control" id="noReferensi" name="noReferensi" placeholder="Nomor Referensi" value="<?= $dataUpdate['noReferensi'] ?? '' ?>">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-12">
                ...
                <div class="form-group">
                    ...
                    if ($flag === 'tambah') {
                    ?>
                        <button type="button" class="btn btn-success" onclick="prosesTujuanTransfer()">
                            <i class="fas fa-save pr-4"></i> <strong>SIMPAN</strong>
                        </button>
                    <?php
                    } else if ($flag === 'update') {
                    ?>
                        <button type="button" class="btn btn-info" onclick="prosesTujuanTransfer()">
                            <i class="fas fa-save pr-4"></i> <strong>SIMPAN</strong>
                        </button>
                    <?php
                    }
