...
?>
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
                                ...
                                <div id="kt_page_sticky_card" class="card card-custom card-sticky">
                                    <div class="card-header">
                                        ...
                                        <div class="card-title">
                                            <h3 class="card-label"><i class="fas fa-stream text-dark pr-4"></i> <strong>DAFTAR TUJUAN TRANSFER</strong></h3>
                                        </div>
                                        <!-- END CARD TITLE -->
                                        <!-- CARD TOOLBAR -->
                                        <div class="card-toolbar">
                                            <a href="detail/" class="btn btn-danger font-weight-bolder">
                                                <i class="fas fa-plus-circle pr-4"></i> <strong>TUJUAN TRANSFER BARU</strong>
                                            </a>
                                        </div>
                                        <!-- END CARD TOOLBAR -->
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <!-- TABLE -->
                                        <div class="table-responsive" id="dataDaftarTujuanTransfer">
        ...
        <script src="js/tujuan_transfer.js"></script>
