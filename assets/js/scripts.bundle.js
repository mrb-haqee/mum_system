                        ...
                        if (options.layout.scroll) {
                            ...
                            if ($(scrollable).find("." + pfx + "datatable-row").length > 0 && $(scrollable).length > 0) {
                                ...
                                scroll.tableLocked = $(datatable.tableBody).find(
                                    "." + pfx + "datatable-lock:not(." + pfx + "datatable-lock-scroll)"
                                );
                                if (
                            ...
                            .each(function () {
                                ...
                                if ($(datatable.tableHead).find("." + pfx + "datatable-toggle-detail").length === 0) {
                                    ...
                                    $(datatable.tableHead)
                                        ...
                                        .first()
                                        .prepend(
                                            '<th class="' + pfx + "datatable-cell " + pfx + 'datatable-toggle-detail"><span></span></th>'
                                        );
                                    $(datatable.tableFoot)
                                        .find("." + pfx + "datatable-row")
                                        .first()
            ...
            height: function () {
                ...
                if (KTUtil.isBreakpointDown("lg")) {
                    ...
                    if (cardHeaderEl) {
                        ...
                        height =
                            height - parseInt(KTUtil.css(cardHeaderEl, "margin-top")) - parseInt(KTUtil.css(cardHeaderEl, "margin-bottom"));
                    }

                    if (cardBodyEl) {
                        height =
                            height - parseInt(KTUtil.css(cardBodyEl, "padding-top")) - parseInt(KTUtil.css(cardBodyEl, "padding-bottom"));
                    }

                    if (cardFooterEl) {
                        height = height - parseInt(KTUtil.css(cardFooterEl, "height"));
                        height =
                            height - parseInt(KTUtil.css(cardFooterEl, "margin-top")) - parseInt(KTUtil.css(cardFooterEl, "margin-bottom"));
                    }
                }
